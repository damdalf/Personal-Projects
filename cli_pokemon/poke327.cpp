...
int main(int argc, char *argv[])
{
  ...
  world.pc.bag[0] = 5; // revives
  world.pc.bag[1] = 5; // potions
  world.pc.bag[2] = 5; // Pokeballs
  world.pc.poke_bucks = 0;
  // Starting with extremely strong Pokemon in the PC's PokeDex to save TA's time when grading.
  world.pc.pokedex.push_back(Pokemon(200));
  world.pc.pokedex.push_back(Pokemon(200));
  world.pc.pokedex.push_back(Pokemon(200));
  world.pc.pokedex.push_back(Pokemon(200));
  world.pc.pokedex.push_back(Pokemon(200));
