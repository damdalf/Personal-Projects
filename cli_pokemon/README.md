# CLI POKEMON
This was a project that I had begun working on while taking COM S 327. This class focused on advanced programming techniques using C and C++, as well as the ncurses library. While there is still many things that I'd like to improve and add to the game, my free time has been limited recently.
## ABOUT THE GAME
